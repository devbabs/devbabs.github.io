...
<div class="main">
                        ...
                        <ul class="project-info-list">
                            <li class="d-flex align-items-center mb-3 p-4 rounded shadow-sm border">
                                ...
                                <div class="d-block">
                                    ...
                                    <p>
                                        <a href="mailto:support@easybill.com.ng">
                                            support@easybill.com.ng
                                        </a>
                                    </p>
                                </div>
                            </li>
                            <li class="d-flex align-items-center mb-3 p-4 rounded shadow-sm border">
                                <span class="ti-mobile icon-sm color-secondary d-block mr-3"></span>
                                <div class="d-block">
                                    <h5 class="mb-0">Phone</h5>
                                    <p>
                                        <a href="tel:2348097777114">
                                            08097777114
                                        </a>
                                    </p>
                                </div>
                            ...
                            <li class="d-flex align-items-center mb-3 p-4 rounded shadow-sm border">
                                <!-- <span class="fab fa-whatsapp icon-sm color-secondary d-block mr-3"></span> -->
                                <img src="img/easybill/whatsapp.png" alt="" height="30px" class="m mr-2">
                                <div class="d-block">
                                    <h5 class="mb-0">WhatsApp</h5>
                                    <a href="tel:2348097777337">
                                        08097777337
                                    </a>
                                </div>
                            </li>
    ...
    <section class="project-details-section ptb-100 d-none">
        <div class="container">
            <div class="row justify-content-between">
                <div class="col-md-12 col-lg-8">
                    <div class="img-wrap mb-md-4 mb-lg-0">
                        <img src="img/project-details.jpg" alt="project" class="img-fluid rounded shadow-sm"/>
                    </div>
                </div>
    ...
    <section class="call-to-action py-5 gray-light-bg d-none">
        <div class="container">
            <div class="row justify-content-around align-items-center">
                ...
                <div class="col-md-4">
                    <div class="action-btn text-lg-right text-sm-left">
                        <a href="#" class="btn solid-btn">Become a Client</a>
                    </div>
                </div>
            </div>
        </div>
...
<footer class="footer-section">
    <!--footer top start-->
    <div class="footer-top gradient-bg d-none">
        <div class="container">
            <div class="row">
        ...
        <div class="container">
            <div class="row text-center justify-content-center">
                <div class="col-md-6 col-lg-5"><p class="copyright-text pb-0 mb-0">
                    All Rights Reserved by EasyBill Power Network Copyright &copy; 2020
                </div>
            </div>
        </div>
    </div>
