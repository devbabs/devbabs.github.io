...
<div class="main">
    ...
    <section class="hero-section ptb-100 gradient-overlay full-screen"
             style="background: url('img/easybill/dp/login-1.jpg')no-repeat center center / cover">
        <div class="container">
            <div class="row align-items-center justify-content-between pt-5 pt-sm-5 pt-md-5 pt-lg-0">
                <div class="col-md-7 col-lg-6">
                    <div class="hero-content-left text-white">
                        <h1 class="text-white d-none">Welcome Back !</h1>
                        <p class="lead d-none">
                    ...
                    <div class="card login-signup-card shadow-lg mb-0">
                        <div class="card-body px-md-5 py-5">
                            ...
                            <form class="login-signup-form">
                                ...
                                <!-- Submit -->
                                <button class="btn btn-block solid-btn border-radius mt-4 mb-3">
                                    Continue
                                </button>
                        ...
                        <div class="card-footer bg-transparent border-top px-md-5">
                            <a href="login.php" class="small"> Return to login</a>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="shape-bottom">
            ...
            <img src="img/wave-shap.svg" alt="wave shape" class="bottom-shape img-fluid">
        </div>
    </section>
    <!--hero section end-->
